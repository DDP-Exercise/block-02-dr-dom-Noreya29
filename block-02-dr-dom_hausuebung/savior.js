...
let simplistic = document.getElementById("message");
simplistic.textContent = "We care for simplistic design!";
...
let lists = document.body.getElementsByTagName("ul");
let fakelist = lists[0];
document.body.removeChild(fakelist);
...
let town = document.getElementsByTagName("p")[1];
...
let evil = document.querySelector(' script[src="dr.dom.js"]');
evil.remove();
